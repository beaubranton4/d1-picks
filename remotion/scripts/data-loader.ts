/**
 * Node.js data loading utilities for rendering scripts
 * This file uses fs/path and should NOT be imported by browser components
 */

import * as fs from 'fs';
import * as path from 'path';
import type { DailyPicks, ManualPick } from '../src/lib/types';
